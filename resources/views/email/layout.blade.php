										...
										<tr>
											<td class="wrapper last">
												<table class="twelve columns">
													<tr>
														<td class="twelve sub-columns last" align="right" style="text-align:center; vertical-align:middle;"><span class="template-label">Copyright &copy; {{ date('Y') }} by <a href="http://www.swiss-magic.net" style="color:#14b2b6;">Swiss Magic</a></span></td>
