<?php namespace Modules\Usermanagement\Providers;
...
class UserManagementServiceProvider extends ServiceProvider {
	...
	{
		$viewPath = base_path('resources/views/modules/usermanagement');
	...
	{
		$langPath = base_path('resources/lang/modules/usermanagement');
